...
var BugService = (function () {
    function BugService(fire) {
        this.fire = fire;
        this.bugDbRef = this.fire.database.ref('/bugs');
    }
    BugService.prototype.getAddedBugs = function () {
        var _this = this;
        return Observable_1.Observable.create(function (obs) {
            _this.bugDbRef.on('child_added', function (bug) {
                var newBug = bug.val();
                newBug.id = bug.key;
                obs.next(newBug);
            }, function (err) {
    ...
    BugService.prototype.changeListener = function () {
        var _this = this;
        return Observable_1.Observable.create(function (obs) {
            _this.bugDbRef.on('child_changed', function (bug) {
                var updateBug = bug.val();
    ...
    BugService.prototype.updateBug = function (bug) {
        var currentBugRef = this.bugDbRef.child(bug.id);
        bug.id = null;
